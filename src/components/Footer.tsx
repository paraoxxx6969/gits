        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/gits-dmce/"
                target="_blank"
                rel="noopener noreferrer"
                title="GITS DMCE on LinkedIn"
                style={{ width: '36px', height: '36px', borderRadius: '8px', background: 'rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', transition: 'background 0.2s, color 0.2s' }}
                onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.background = '#0a66c2'; }}
